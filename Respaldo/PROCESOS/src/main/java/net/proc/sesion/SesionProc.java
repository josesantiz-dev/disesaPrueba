...
public class SesionProc implements Serializable {
	...
	private Opciones.Grupo.Subgrupo.Programa programa;
	...
	public Opciones.Grupo.Subgrupo.Programa getPrograma() {
		return this.programa;
	}
	
	public void setPrograma(Opciones.Grupo.Subgrupo.Programa programa) {
		this.paginaSeleccionada = Long.valueOf(programa.getcPrograma().id);
