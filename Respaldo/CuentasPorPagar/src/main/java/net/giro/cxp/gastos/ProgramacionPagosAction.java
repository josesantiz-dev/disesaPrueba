...
public class ProgramacionPagosAction {
	...
	public ProgramacionPagosAction() {
		...
		try {
			...
			loginManager = (LoginManager) valExp.getValue(this.facesContext.getELContext());
			...
			//this.ifzCatEmpresas = (EmpresasRem)  		this.ctx.lookup("ejb:/Logica_Publico//EmpresasFac!net.giro.plataforma.logica.EmpresasRem");
			//this.ifzFinFdoRva 	= (FiniquitoFondoReservaRem) 	this.ctx.lookup("");
			
			this.ifzOrdenesCompra.setInfoSecion(loginManager.getInfoSesion());
