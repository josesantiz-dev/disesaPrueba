...
public class ObraCobranza implements Serializable {
	...
	public ObraCobranza(Long id, Obra idObra, String nombreObra, Long idFactura, String folio, Date fecha, 
			Long idConcepto, String concepto, BigDecimal monto, BigDecimal anticipo, BigDecimal estimacion, BigDecimal amortizacion,
			BigDecimal fondoGarantia, BigDecimal subtotal, BigDecimal iva, BigDecimal total, BigDecimal porcentajeAnticipo, BigDecimal porcentajeRetencion,
