...
public class PolizasInterfacesImp extends DAOImpl<PolizasInterfaces> implements PolizasInterfacesDAO {
	...
	public void orderBy(String orderBy) {
		PolizasInterfacesImp.orderBy = orderBy;
	}

	@Override
	@SuppressWarnings("unchecked")
	public List<PolizasInterfaces> findByProperty(String propertyName, Object value, int limite) throws Exception {
		String queryString = "select model from PolizasInterfaces model ";
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<PolizasInterfaces> findLikeProperty(String propertyName, Object value, int limite) throws Exception {
		String queryString = "select model from PolizasInterfaces model ";
