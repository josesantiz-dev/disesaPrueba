...
public class EstructuraImportacionCuentaExt implements Serializable { 
	...
	public EstructuraImportacionCuentaExt() {
		idCuenta = new CtasBancoExt();
	}
	...
	public CtasBancoExt getIdCuenta() {
		return idCuenta;
	}
	public void setIdCuenta(CtasBancoExt idCuenta) {
