...
public class ProductoFac implements ProductoRem {
	...
	public Long save(Producto entity) throws ExcepConstraint {
		try {
			return this.ifzProductos.save(entity);
	...
	@Override
	public Producto update(Producto entity) throws ExcepConstraint {
		try {
	...
	public Producto findByClave(String clave) {
		try {
			List<Producto> lista = this.ifzProductos.findByProperty("clave", clave);
			if(lista.isEmpty())
				return null;
			return lista.get(0);
		} catch (RuntimeException re) {
	...
	public Long save(ProductoExt entityExt) throws ExcepConstraint {
		try {
			Producto entity = this.convertidor.ProductoExtToProducto(entityExt);
			return this.ifzProductos.save(entity);
		} catch (RuntimeException re) {	
			throw re;
		}
	...
	@Override
	public Producto update(ProductoExt entityExt) throws ExcepConstraint {
		try {
			Producto entity = this.convertidor.ProductoExtToProducto(entityExt);
			this.ifzProductos.update(entity);
			return entity;
