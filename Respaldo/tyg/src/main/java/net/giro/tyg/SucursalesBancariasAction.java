...
public class SucursalesBancariasAction  {
	...
	Logger log = Logger.getLogger(SucursalesBancariasAction.class);
	...
	private List<CatBancos> listTmpBancos;
	private List<SelectItem> listBancos;
	private List<Estado> listTmpEstados;
	private List<CatBancos> listTmpCatBancos;
	...
	public SucursalesBancariasAction() throws Exception {
		...
		listTmpBancos = new ArrayList<CatBancos>();
	...
	public void cargarSelectBancos(){
		try{
			...
			if(respuesta.getErrores().getCodigoError() == 0){
				listTmpCatBancos = (List<CatBancos>)respuesta.getBody().getValor("listBancos");
				listBancos.clear();
				for (CatBancos i : listTmpCatBancos) 
	...
	public void setListTmpSucursalBancaria(
			List<SucursalBancaria> listTmpSucursalBancaria) {
	...
	public List<CatBancos> getListTmpBancos() {
		return listTmpBancos;
	}
	public void setListTmpBancos(List<CatBancos> listTmpBancos) {
	...
	public void setListInstitucionesBancarias(
			ArrayList<SelectItem> listInstitucionesBancarias) {
	...
	public List<CatBancos> getListTmpCatBancos() {
		return listTmpCatBancos;
	}
	public void setListTmpCatBancos(List<CatBancos> listTmpCatBancos) {
		this.listTmpCatBancos = listTmpCatBancos;
	}
	public CatBancos getPojoBanco() {
		return pojoBanco;
	}
	public void setPojoBanco(CatBancos pojoBanco) {
