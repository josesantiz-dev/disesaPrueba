...
public class FacturaDetalleImpuesto implements Serializable {
	...
	public FacturaDetalleImpuesto(Long id, Long idFacturaDetalle, Short idImpuesto, BigDecimal monto, 
	...
	public Short getIdImpuesto() {
		return idImpuesto;
	}

	public void setIdImpuesto(Short idImpuesto) {
		this.idImpuesto = idImpuesto;
	}
