...
public interface ObraRem {
	...
	//public void setAutentificacion(AutentificacionRem auth);
	...
	public Long save(ObraExt entity) throws ExcepConstraint;
		
	public void update(ObraExt entity) throws ExcepConstraint;
