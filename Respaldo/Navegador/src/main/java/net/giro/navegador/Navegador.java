...
public class Navegador implements Serializable{
	...
	private HtmlToolBar htmlMenu = null;
	HtmlAjaxSupport a4jSupportComp = null;
	
	private HashMap<Integer, String> listIcons; 
	
	ServletContext servletCon = null;
	HttpSession httpSession;
	
	ExpressionFactory expressionFactory = null;
	//HtmlAjaxSupport a4jSupportComp = null;
	ValueExpression target = null;
	ValueExpression valor = null;
	...
	public Navegador() {
		...
		PropertyResourceBundle prop = (PropertyResourceBundle)dato.getValue(facesContext.getELContext());
	...
	public Pagina getMenu() {
		...
		} catch (Exception e) {log.error("Eror en metodo getMenu",e);}
    	return menuRoot;		
	}
