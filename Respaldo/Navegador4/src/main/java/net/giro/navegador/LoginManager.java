...
public class LoginManager  implements Serializable{ 
    ...
    public LoginManager() {
        ...
        try {
        	...
        	System.out.println("Imprime FACESCONTEXT");
        	System.out.println(facesContext.getAttributes().toString());
	...
	public void inicializa() {
    	...
    	System.out.println("Verificacion: " + validated);

        if (LOGIN_SUCCESS.equals(validated)) {
        	this.mensaje = "";
        	this.loginValidateOutcome = LOGIN_SUCCESS;
        	System.out.println("Verificacion: " + this.loginValidateOutcome);
    ...
    protected String verifyUserBean() {
        try {
        	...
        	System.out.println(this.aplicacionId);
	...
	public void setUsuarioResponsabilidad(
			UsuarioResponsabilidad usuarioResponsabilidad) {
