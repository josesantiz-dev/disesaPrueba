...
@Stateless
public class ConceptoEquivalenciaImp extends DAOImpl<ConceptoEquivalencia> implements ConceptoEquivalenciaDAO {
	@PersistenceContext
	...
	public List<ConceptoEquivalencia> findAll(long codigoTransaccion, String orderBy) throws Exception {
		String queryString = "select model from ConceptoEquivalencia model where model.transaccion = :codigoTransaccion ";
	...
	public List<ConceptoEquivalencia> findByProperty(String propertyName, Object value, long idEmpresa, String orderBy, int limite) throws Exception {
		String queryString = "select model from ConceptoEquivalencia model where model.idEmpresa = :idEmpresa ";
 ...
 * ----------------------------------------------------------------------------------------------------------------
 *  2.1 | 2019-05-17 | Javier Tirado 	| Creacion de ConceptoEquivalenciaImp
 */
