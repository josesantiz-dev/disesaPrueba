...
public class ConceptosImp extends DAOImpl<Conceptos> implements ConceptosDAO {
	...
	/*@Override
	@SuppressWarnings("unchecked")
	public List<Conceptos> findInProperty(String columnName, List<Object> values, long idEmpresa, int limite) throws Exception {
		String queryString = "select model from Conceptos model where model.idEmpresa = :idEmpresa ";
    	String sqlWhere = "";
    	String inFilter = "";
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<Conceptos> findByProperties(HashMap<String, String> params, long idEmpresa, int limite) throws Exception {
		String queryString = "select model from Conceptos model where model.idEmpresa = :idEmpresa ";
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<Conceptos> findLikeProperties(HashMap<String, String> params, long idEmpresa, int limite) throws Exception {
		String queryString = "select model from Conceptos model where model.idEmpresa = :idEmpresa ";
