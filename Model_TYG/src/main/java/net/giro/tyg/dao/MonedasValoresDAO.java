...
public interface MonedasValoresDAO extends DAO<MonedasValores> {
	public long save(MonedasValores entity, Long codigoEmpresa) throws ExcepConstraint;
    
    public List<MonedasValores> saveOrUpdateList(List<MonedasValores> entities, Long codigoEmpresa) throws Exception;
