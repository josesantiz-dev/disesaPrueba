...
public class AsignacionGruposAction implements Serializable {
	...
	public AsignacionGruposAction() {
		try {
			...
			this.tiposBusqueda.add(new SelectItem("idTransaccion.codigo", "Transaccion"));
	...
	public void buscar() {
		try {
			...
			this.ifzAsigGrupos.orderBy("tr.codigo, model.idGrupoDebito, model.idGrupoCredito, model.idFormaPago, model.idConcepto, model.id desc");
