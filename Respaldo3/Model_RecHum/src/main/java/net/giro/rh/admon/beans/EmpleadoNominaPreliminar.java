...
/**
 * empleado_nomina_preliminar
 * @author javaz
 */
public class EmpleadoNominaPreliminar implements Serializable {
	...
	private int diaFestivo; // indica si el dia es festivo
	...
	public EmpleadoNominaPreliminar() {
		this.observaciones = "";
	...
	public void convetir(EmpleadoNomina empleadoNomina) {
		this.id = empleadoNomina.getId();
		this.tipo = empleadoNomina.getTipo();
		this.idEmpleado = empleadoNomina.getIdEmpleado();
		this.idContrato = empleadoNomina.getIdContrato();
		this.idPeriodicidad = empleadoNomina.getIdPeriodicidad();
		this.idObra = empleadoNomina.getIdObra();
		this.fecha = empleadoNomina.getFecha();
		this.diaDescanso = empleadoNomina.getDiaDescanso();
		this.diaFestivo = empleadoNomina.getDiaFestivo();
		this.factor = empleadoNomina.getFactor();
		this.horasTrabajadas = empleadoNomina.getHorasTrabajadas();
		this.horasExtras = empleadoNomina.getHorasExtras();
		this.pagoNormal = empleadoNomina.getPagoNormal();
		this.septimoDia = empleadoNomina.getSeptimoDia();
		this.pagoExtra = empleadoNomina.getPagoExtra();
		this.descuento = empleadoNomina.getDescuento();
		this.infonavit = empleadoNomina.getInfonavit();
		this.pagoNeto = empleadoNomina.getPagoNeto();
		this.idEmpresa = empleadoNomina.getIdEmpresa();
		this.observaciones = empleadoNomina.getObservaciones();
		this.creadoPor = empleadoNomina.getCreadoPor();
		this.fechaCreacion = empleadoNomina.getFechaCreacion();
		this.modificadoPor = empleadoNomina.getModificadoPor();
		this.fechaModificacion = empleadoNomina.getFechaModificacion();
	}
}
