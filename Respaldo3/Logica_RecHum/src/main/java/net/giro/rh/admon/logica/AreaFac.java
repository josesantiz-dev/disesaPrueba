...
public class AreaFac implements AreaRem {
	...
	public Long save(Area entity) throws Exception {
		try {
			return this.ifzArea.save(entity, getCodigoEmpresa());
		} catch (Exception re) {	
			throw re;
		}
	}
	...
	public List<Area> saveOrUpdateList(List<Area> entities) throws Exception {
		try {
			return this.ifzArea.saveOrUpdateList(entities, getCodigoEmpresa());
		} catch (Exception re) {	
			throw re;
		}
	}
	...
	public List<Area> findAll() {
		try {
			return this.ifzArea.findAll(getIdEmpresa());
		} catch (Exception re) {		
			throw re;
		}
	}
	...
	public List<Area> findAllActivos() {
		try {
			return this.ifzArea.findAllActivos(getIdEmpresa());
		} catch (Exception re) {		
			throw re;
		}
	}
	...
	public List<Area> findByProperty(String propertyName, final Object value) {
		try {
			return this.ifzArea.findByProperty(propertyName, value, getIdEmpresa());
		} catch (Exception re) {
			throw re;
		}
	}
	...
	@Override
	public List<Area> findLikeProperty(String propertyName, final Object value) {
		try {
			return this.ifzArea.findLikeProperty(propertyName, value, getIdEmpresa());
		} catch (Exception re) {
			throw re;
		}
	}
	...
	public List<Area> findByPropertyPojoCompleto(String propertyName, String tipo, long value){
		try {
			return this.ifzArea.findByPropertyPojoCompleto(propertyName, tipo, value, getIdEmpresa());
		} catch (Exception re) {
			throw re;
		}
	}
	...
	public List<AreaExt> findByPropertyExt(String propertyName, final Object value) {
		...
		try {
			listAreas = this.findByProperty(propertyName, value);
	...
	@Override
	public List<AreaExt> findLikePropertyExt(String propertyName, final Object value) {
		List<AreaExt> listaExt = new ArrayList<AreaExt>();
		List<Area> listAreas = null;
		
		try {
			listAreas = this.findLikeProperty(propertyName, value);
			for(Area area : listAreas)
				listaExt.add(this.convertidor.AreaToAreaExt(area));
		} catch (Exception re) {
			throw re;
