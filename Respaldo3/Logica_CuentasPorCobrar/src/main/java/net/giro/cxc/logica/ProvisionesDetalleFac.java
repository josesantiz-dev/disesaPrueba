...
public class ProvisionesDetalleFac implements ProvisionesDetalleRem {
	...
	public Long save(ProvisionesDetalle entity) throws Exception {
		try {
			return this.ifzProvisionesDetalle.save(entity, getIdEmpresa());
		} catch (Exception e) {
	...
	public List<ProvisionesDetalle> saveOrUpdateList(List<ProvisionesDetalle> entities) throws Exception {
		try {
			return this.ifzProvisionesDetalle.saveOrUpdateList(entities, getIdEmpresa());
		} catch (Exception e) {
			log.error("Error en Logica_CuentasPorCobrar.ProvisionesDetalleFac.saveOrUpdateList(List<ProvisionesDetalle> entities)", e);
			throw e;
		}
	}
