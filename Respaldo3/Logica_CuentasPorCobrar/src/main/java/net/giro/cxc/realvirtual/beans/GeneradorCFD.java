...
public class GeneradorCFD { 
	...
	*/ 
	...
	public GeneradorCFD(Document document, InputStream archivoClavePrivada, String password, String version, boolean debug) throws GeneralSecurityException {
		this.isDebug = debug;
		this.version = version;
		this.document = document;
	...
	*/ 
	 ...
	 */
	private boolean generaCadenaOriginal() {
		InputStream is = null;
		...
		try {
			if (this.cadenaOriginal == null || "".equals(this.cadenaOriginal.trim())) {
				...
				if ("3.3".equals(this.version)) 
					is = GeneradorCFD.class.getResourceAsStream((this.isDebug ? "/net/giro/cxc/fe/cadenaoriginal_3_3_local.xslt" : "/net/giro/cxc/fe/cadenaoriginal_3_3.xslt")); 
				else
					is = GeneradorCFD.class.getResourceAsStream("/net/giro/cxc/fe/cadenaoriginal_3_2.xslt"); 
