...
public class ImpuestosAction {
	...
	public String guardar() {
		try {
			resOperacion = "";
			this.pojoValores.setAtributo4(this.claveSat);
	...
	public boolean isDesglosar() {
		boolean desgloce = this.pojoValores.getAtributo3() == null ? false:(this.pojoValores.getAtributo3() == "1" ? true:false);
		return desgloce;
	}

	public void setDesglosar(boolean desglosar) {
		if(desglosar == true)
			this.pojoValores.setAtributo3("1");
		else
			this.pojoValores.setAtributo3("0");
	...
	public void setPojoValores(ConValores pojoValores) {
		...
		this.claveSat = this.pojoValores.getAtributo4();
	}
	...
	public String getAtributo4() {
		if (pojoValores.getAtributo4() != null)
			return pojoValores.getAtributo2();
		return "0";
	}
	
	public void setAtributo4(String atributo4) {
		this.pojoValores.setAtributo4(atributo4);
	}
