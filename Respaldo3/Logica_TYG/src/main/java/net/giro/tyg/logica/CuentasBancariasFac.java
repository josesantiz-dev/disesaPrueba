...
public class CuentasBancariasFac implements CuentasBancariasRem {
	...
	public long save(CuentaBancaria entity) throws Exception {
		try {
			this.ifzCtasBanco.save(entity, getCodigoEmpresa());
			return entity.getId();
		} catch (Exception re) {
	...
	public List<CuentaBancaria> findAll() throws Exception {
		try {
			return this.findAll(getIdEmpresa(), "", 0);
		} catch (Exception re) {
			throw re;
		}
	}
	...
	@Override
	public List<CuentaBancaria> findAll(Long idEmpresa) throws Exception {
		try {
			return this.findAll(idEmpresa, "", 0);
		} catch (Exception re) {
			throw re;
		}
	}
	...
	public List<CuentaBancaria> findAll(long idEmpresa, String orderBy, int limite) throws Exception {
		try {
			return this.ifzCtasBanco.findAll(idEmpresa, orderBy, limite);
		} catch (Exception re) {
			throw re;
		}
	}
