...
public class InsumosDetalles implements Serializable {
	...
	public double getPendiente() {
		return ((this.cantidad - this.cantidadSurtida) >= 0) ? (this.cantidad - this.cantidadSurtida) : 0;
	}
	...
	public double getSuministrado() {
		try {
			if (this.cantidadSurtida >= this.cantidad)
				return 1;
			if (this.cantidadSurtida < this.cantidad) 
				return (this.cantidadSurtida / this.cantidad);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void setSuministrado(double value) {}
	
	public void addSuministrado(double cantidad) {
		this.cantidadSurtida += cantidad;
		this.cantidadSurtida = (this.cantidadSurtida > 0 ? this.cantidadSurtida : 0);
		this.cantidadSurtida = (this.cantidadSurtida <= this.cantidad ? this.cantidadSurtida : this.cantidad);
	}
}
