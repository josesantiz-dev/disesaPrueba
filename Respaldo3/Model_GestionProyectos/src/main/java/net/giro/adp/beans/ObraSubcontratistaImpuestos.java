...
/**
 * obra_subcontratista_impuestos
 * @author javaz
 */
public class ObraSubcontratistaImpuestos implements Serializable {
	private static final long serialVersionUID = 1L;
	private Long id;
	private ObraSubcontratista idObraSubcontratista;
	...
	public ObraSubcontratistaImpuestos() {
		this.nombreImpuesto = "";
	...
	public ObraSubcontratista getIdObraSubcontratista() {
		return idObraSubcontratista;
	}
	
	public void setIdObraSubcontratista(ObraSubcontratista idObraSubcontratista) {
		this.idObraSubcontratista = idObraSubcontratista;
	}
