...
public class ObraContratosImp extends DAOImpl<ObraContratos> implements ObraContratosDAO {
	...
	public List<ObraContratos> findByProperty(String propertyName, Object value, long idEmpresa, int limite) throws Exception {
		String queryString = "select model from ObraContratos model where model.idObra.idEmpresa = :idEmpresa ";
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<ObraContratos> findLikeProperty(String propertyName, Object value, long idEmpresa, int limite) throws Exception {
		String queryString = "select model from ObraContratos model where model.idObra.idEmpresa = :idEmpresa ";
