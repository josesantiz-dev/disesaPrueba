...
@Stateless
public class FacturaPagosTimbreImp extends DAOImpl<FacturaPagosTimbre> implements FacturaPagosTimbreDAO {
	@PersistenceContext
	...
	public long saveOrUpdate(FacturaPagosTimbre entity, long codigoEmpresa) throws Exception {
		...
		try {
			if (entity.getId() == null || entity.getId() <= 0L)
				idTimbre = super.save(entity, codigoEmpresa);
			else
				super.update(entity);
	...
	public List<FacturaPagosTimbre> findAll(long idEmpresa) throws Exception {
		String queryString = "select model from FacturaPagosTimbre model where model.idEmpresa = :idEmpresa ";
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<FacturaPagosTimbre> findByProperty(String propertyName, Object value, long idEmpresa, int limite) throws Exception {
		String queryString = "select model from FacturaPagosTimbre model where model.idEmpresa = :idEmpresa ";
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<FacturaPagosTimbre> findLikeProperty(String propertyName, Object value, long idEmpresa, int limite) throws Exception {
	...
	public List<FacturaPagosTimbre> comprobarTimbre(String serie, String folio, long idEmpresa) throws Exception {
		String queryString = "select model from FacturaPagosTimbre model where model.idEmpresa = :idEmpresa and model.serie = :serie and model.folio = :folio order by model.id desc ";
