...
public class CuentasBancariasAction{
	...
	public void setListSucursalesBancarias(List<SucursalBancaria> listSucursalesBancarias) {
	...
	public void setListTmpSucursalesBancarias(List<SelectItem> listTmpSucursalesBancarias) {
	...
	public void setListTmpCuentasBancarias(ArrayList<SelectItem> listTmpCuentasBancarias) {
