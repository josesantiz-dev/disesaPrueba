...
import net.giro.plataforma.impresion.Ftp;
import net.giro.plataforma.impresion.RespuestaCrearJob;
...
public class SeguimientoFac implements SeguimientoRem{
	...
	public Respuesta expirarSeguimiento(SeguimientoExt seguimientoExt) {
		...
		try {
			...
			if(seguimiento.getId() > 0){			
				...
				seguimientoExt.setId(this.ifzSeguimiento.save(seguimiento, null));
			}
	...
	public Respuesta insertaSeguimientoProspecto(SeguimientoExt pojoSeguimientoExt) {
		...
		try{
			...
			pojoSeguimientoExt.setId(ifzSeguimiento.save(pojoSeguimientoResponder, null));
