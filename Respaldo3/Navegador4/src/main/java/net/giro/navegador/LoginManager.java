...
public class LoginManager implements Serializable { 
    ...
    public LoginManager() {
        ...
        try {
        	...
        	valParameter = (valParameter != null && ! "".equals(valParameter.trim())) ? valParameter.trim() : "0";
    		this.aplicacionId = Long.valueOf(valParameter);

        	request = (HttpServletRequest) facesContext.getExternalContext().getRequest();
    		this.ipAddress = request.getHeader("X-FORWARDED-FOR");
    		this.ipAddress = (this.ipAddress != null && ! "".equals(this.ipAddress.trim())) ? this.ipAddress.trim() : request.getRemoteAddr();
        } catch (Exception e) {
	...
	/*public List<String> getUsuarios() {
		return this.autentificacion.usuarios();
	}
	
	public HashMap<String, String> getSessiones() {
		return this.autentificacion.sessiones();
	}*/
