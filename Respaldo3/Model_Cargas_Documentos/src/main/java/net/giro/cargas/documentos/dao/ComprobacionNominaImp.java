...
@Stateless
public class ComprobacionNominaImp extends DAOImplFact<ComprobacionNomina> implements ComprobacionNominaDAO {
	@PersistenceContext
	...
	@Override
	public List<ComprobacionNomina> saveOrUpdateList(List<ComprobacionNomina> entities, long codigoEmpresa) throws Exception {
		try {
			codigoEmpresa = (codigoEmpresa <= 0L ? 1L : codigoEmpresa);
	...
	public List<ComprobacionNomina> comprobar(String expresionImpresa, boolean incluyeCancelados, String orderBy, long idEmpresa) throws Exception {
		String queryString = "select model from ComprobacionNomina model where model.idEmpresa = :idEmpresa and trim(model.expresionImpresa) = trim(:expresionImpresa) ";
	...
	public List<ComprobacionNomina> findByDates(Date fechaDesde, Date fechaHasta, boolean incluyeCancelados, String orderBy, long idEmpresa) throws Exception {
		String queryString = "select model from ComprobacionNomina model where model.idEmpresa = :idEmpresa ";
 ...
 * ----------------------------------------------------------------------------------------------------------------
 *  1.2 | 2020-03-06  | Javier Tirado 		 | Creacion de EJB
 */