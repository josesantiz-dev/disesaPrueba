...
public class CajaChicaMovimientosAction implements Serializable {
    ...
    private List<String> listTipoBusquedaCuentasBanco;
    private String tipoBusquedaCuentasBanco;
    private String valorBusquedaCuentasBanco;
    private String tipoBusquedaSucursales;
    private String valorBusquedaSucursales;
    private String tipoBusquedaPersonas;
    ...
    private List<PagosGastosExt> listMovimientosCuentas;
    //private List<Gastos> listGastos;
    private List<CtasBancoExt> listBusquedaCuentasBanco;
    private List<PersonaExt> listBusquedaPersonas;
    private List<SucursalExt> listBusquedaSucursales;
    private PagosGastosExt pojoMovimientosCuentas;
    //private Gastos pojoGastos;
    private CajaChicaRem ifzCajaChica;
    //private CtasBancoRem ifzCtas;
    private int numPaginaBusquedaCuentasBanco;
    private int numPaginaBusquedaPersonas;
    private int numPaginaBusquedaSucursales;
	@SuppressWarnings("unused")
	private int tipoMensaje;
	// Agregadas temporalmente para ver funcionar la vista
	private String encontroMismoGrupo;
	private String mensaje;
	private String campoBusqueda;
	private CtasBancoExt pojoCtasBancoExt;
	...
	public String cancelar() {
		try{
			...
			resp = this.ifzCajaChica.cancelacion(this.pojoMovimientosCuentas, Calendar.getInstance().getTime());
	...
	public void guardar(){
		try{
			...
			if(registroNuevo){	
				...
				res = this.ifzCajaChica.salvar(this.pojoMovimientosCuentas,false);
				...
				this.ifzCajaChica.actualizar(this.pojoMovimientosCuentas, "G", Calendar.getInstance().getTime());
