...
public class EmpresasFac implements EmpresasRem {
	...
	public Long save(Empresa entity) throws Exception {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.save(Empresa)", e);
			throw e;
		}
	}
	...
	public void update(Empresa entity) throws Exception {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.update(Empresa)", e);
			throw e;
		}
	}
	...
	public void delete(Long entityId) throws Exception {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.delete(Long)", e);
			throw e;
		}
	}
	...
	public Empresa findById(Long id) {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.findById(id)", e);
			throw e;
		}
	}
	...
	public List<Empresa> findFoolById(Long idEmpresa) throws Exception {
		...
		try {
			empresa = this.findById(idEmpresa);
			if (empresa != null && empresa.getId() != null && empresa.getId() > 0L)
				resultado.add(empresa);
			return resultado;
		} catch (Exception e) {
			log.error("error en Logica_Publico.EmpresasFac.findFoolById(id)", e);
			throw e;
		}
	}
	...
	public List<Empresa> findAll() throws Exception {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.findAll()", e);
			throw e;
		} finally {
			orderBy = null;
		}
	...
	public List<Empresa> findByProperty(String propertyName, Object value, int limite) throws Exception {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.findByProperty(propertyName, value, limite)", e);
			throw e;
		} finally {
			orderBy = null;
		}
	...
	public List<Empresa> findLikeProperty(String propertyName, Object value, int limite) throws Exception {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.findLikeProperty(propertyName, value, limite)", e);
			throw e;
		} finally {
			orderBy = null;
		}
	...
	public List<Empresa> findInProperty(String columnName, List<Object> values, int limite) throws Exception {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.findInProperty(columnName, values, limite)", e);
			throw e;
		} finally {
			orderBy = null;
		}
	...
	public List<Empresa> findByProperties(HashMap<String, Object> params, int limite) throws Exception {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.findByProperties(params, limite)", e);
			throw e;
		} finally {
			orderBy = null;
		}
	...
	public List<Empresa> findLikeProperties(HashMap<String, String> params, int limite) throws Exception {
		try {
			...
			log.error("error en Logica_Publico.EmpresasFac.findLikeProperties(params, limite)", e);
			throw e;
		} finally {
			orderBy = null;
		}
...
//----------------------------------------------------------------------------------------------------------------
//	  2.2	| 01/07/2016 | Javier Tirado	| Modificacion de EmpresasFac