...
function cargarXML(operacionCancelada, tipoMensaje, pnlUpload, pnlMensajes) {
	var debugging = isDebugging();

	if (debugging) console.log('--------------------------------------------------------');
	if (debugging) console.log('cargarXML(operacionCancelada, tipoMensaje, pnlUpload, pnlMensajes)');
	if (debugging) console.log('  operacionCancelada : ', operacionCancelada);
	if (debugging) console.log('  tipoMensaje        : ', tipoMensaje);
	if (debugging) console.log('  pnlUpload          : ', pnlUpload);
	if (debugging) console.log('  pnlMensajes        : ', pnlMensajes);
	

	if (debugging) console.log('---> validando operacion ... ');
	if (operacionCancelada == true) { 
		RichFaces.ui.PopupPanel.showPopupPanel(pnlMensajes);
		console.log('fun.cargarXML :: ERROR');
		console.log('--------------------------------------------------------');
		return;
	} 
	...
	if (debugging) console.log('fun.cargarXML :: DONE');
	if (debugging) console.log('--------------------------------------------------------');
}
...
function reporte(operacionCancelada, pnlMensajes) {
	...
	reportWindow = window.open('./reportes/ReporteGeneric.faces', 'GP', 'menubar=0, toolbar=0, scrollbars=1, location=0, status=1');
	if (window.focus) 
		reportWindow.focus();
