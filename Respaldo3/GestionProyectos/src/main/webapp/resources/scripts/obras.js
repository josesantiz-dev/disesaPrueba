...
function salvarConfirmar(operacionCancelada, confirmar, pnlConfirmacion, pnlOperacion, pnlMensajes, validador) {
	...
	salvarObra(operacionCancelada, pnlOperacion, pnlMensajes);
}

function salvarObra(operacionCancelada, pnlOperacion, pnlMensajes) {
	console.log('\n------------------------------\nfunction salvarObra(operacionCancelada, pnlOperacion, pnlMensajes)');
	console.log('operacionCancelada : ' + operacionCancelada);
	console.log('      pnlOperacion : ' + pnlOperacion);
	console.log('       pnlMensajes : ' + pnlMensajes);
	...
	RichFaces.ui.PopupPanel.showPopupPanel(pnlMensajes);
	RichFaces.ui.PopupPanel.hidePopupPanel(pnlOperacion);
	console.log('salvarObra DONE\n------------------------------');
}

function cancelarObra(operacionCancelada, pnlMensajes) {
	console.log('\n------------------------------\nfunction cancelarObra(operacionCancelada, pnlMensajes)');
	console.log('operacionCancelada : ' + operacionCancelada);
	console.log('       pnlMensajes : ' + pnlMensajes);
