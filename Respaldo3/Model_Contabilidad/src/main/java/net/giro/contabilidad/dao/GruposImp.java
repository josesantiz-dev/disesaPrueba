...
public class GruposImp extends DAOImpl<Grupos> implements GruposDAO {
	...
	public List<Grupos> findByProperty(String propertyName, Object value, long idEmpresa, int limite) throws Exception {
	...
	@Override
	@SuppressWarnings("unchecked")
	public List<Grupos> findLikeProperty(String propertyName, Object value, long idEmpresa, int limite) throws Exception {
		String queryString = "select model from Grupos model where model.idEmpresa = :idEmpresa and model.estatus = 0 ";
