...
public class Usuario implements Serializable { 
	...
	public Usuario(long id, String usuario, String nombre, String puesto,
			String password, Date fechaIni, Date fechaTerm, Long creadoPor,
			Date fechaCreacion, Long modificadoPor, Date fechaModificacion,
			Long expirado, Date fechaCambio, long bloqueado, Date ultimoAcceso,
			String usuarioSpark, String correo, Long idEmpleado, Long version) {
		this.id = id;
