...
public class EmpleadoFac implements EmpleadoRem {
	...
	public Long save(Empleado entity) throws Exception {
		try {
			return this.ifzEmpleado.save(entity, getIdEmpresa());
		} catch (Exception re) {	
			throw re;
		}
	}
	...
	public List<Empleado> saveOrUpdateList(List<Empleado> entities) throws Exception {
		try {
			return this.ifzEmpleado.saveOrUpdateList(entities, getIdEmpresa());
		} catch (Exception re) {	
			throw re;
		}
	}
	...
	public List<Empleado> findAllActivos() {
		try {
			return this.ifzEmpleado.findAllActivos(getIdEmpresa());
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<Empleado> findBy(Object value, String orderBy, int limite) throws Exception {
		try {
			return this.ifzEmpleado.findBy(value, orderBy, limite, getIdEmpresa());
		} catch (Exception re) {		
			throw re;
		}
	}
	...
	public List<Empleado> findByProperty(String propertyName, Object value, int limite) {
		try {
			return this.ifzEmpleado.findByProperty(propertyName, value, getIdEmpresa());
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public List<Empleado> findLike(String value, String orderBy, int limite) throws Exception {
		try {
			...
			if (value.contains(" "))
				value = value.replace(" ", "%");
			return this.ifzEmpleado.findLike(value, orderBy, limite, getIdEmpresa());
		} catch (Exception re) {		
			throw re;
		}
	}
	...
	public List<Empleado> findLikeProperty(String propertyName, Object value, int limite) {
		try {
			return this.ifzEmpleado.findLikeProperty(propertyName, value, limite, getIdEmpresa());
		} catch (Exception e) {
	...
	public List<Empleado> findLikeProperties(HashMap<String, String> params) throws Exception {
		try {
			return this.ifzEmpleado.findLikeProperties(params, getIdEmpresa());
		} catch (Exception e) {
	...
	public List<Empleado> findLikeNombreEmpleado(String nombreEmpleado) {
		try {
			return this.ifzEmpleado.findByEmpleado(nombreEmpleado, getIdEmpresa());
		} catch (RuntimeException re) {		
			throw re;
		}
	}
	...
	public List<Empleado> findByPropertyPojoCompleto(String propertyName, String tipo, long value) {
		try {
			return this.ifzEmpleado.findByPropertyPojoCompleto(propertyName, tipo, value, getIdEmpresa());
		} catch (RuntimeException re) {
			throw re;
		}
	}
	...
	public boolean findEmpleadoRepetido(long idEmpleado) {
		try {
			List<Empleado> lista = this.ifzEmpleado.findEmpleadoRepetido(idEmpleado, getIdEmpresa());
			if (lista == null)
	...
	public Long save(EmpleadoExt entityExt) throws Exception {
		try {
			return this.save(this.convertidor.EmpleadoExtToEmpleado(entityExt));
		} catch (RuntimeException re) {	
			throw re;
		}
	}
	...
	@Override
	public void update(EmpleadoExt entityExt) throws Exception {
		try {
			this.ifzEmpleado.update(this.convertidor.EmpleadoExtToEmpleado(entityExt));
		} catch (RuntimeException re) {	
			throw re;
		}
	}
	...
	public List<EmpleadoExt> findExtLikeNombreEmpleado(String nombreEmpleado) {
		...
		try {
			List<Empleado> listaEmpleados = this.findLikeNombreEmpleado(nombreEmpleado);
