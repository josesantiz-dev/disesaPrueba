...
public class EmpleadoExt implements Serializable {
	...
	public String getNombrePorApellidos() {
		String apelsNombre = "";
		if (persona != null) {
			apelsNombre += this.primerApellido + " ";
			apelsNombre += this.segundoApellido + " ";
			apelsNombre += this.primerNombre + " ";
			apelsNombre += this.segundoNombre;
			apelsNombre = apelsNombre.replace("  ", " ").trim();
		}
