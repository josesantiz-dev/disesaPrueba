...
public class ChecadorDetalleFac implements ChecadorDetalleRem {
	...
	public void update(ChecadorDetalle ChecadorDetalle) throws Exception {
		try {
			this.ifzChecadorDetalles.setEmpresa(getIdEmpresa());
	...
	@Override
	public void delete(Long ChecadorDetalle) throws Exception {
		try {
			this.ifzChecadorDetalles.setEmpresa(getIdEmpresa());
	...
	public ChecadorDetalle existeAsistenciaPojo(Long idChecador, Long idEmpleado, Date fecha) throws Exception {
		...
		try {
			...
			this.ifzChecadorDetalles.setEmpresa(getIdEmpresa());
			lista = this.ifzChecadorDetalles.findByProperties(params, 120);			
	...
	@Override
	public Long save(ChecadorDetalleExt ChecadorDetalleExt) throws Exception {
		try {
	...
	@Override
	public void update(ChecadorDetalleExt ChecadorDetalleExt) throws Exception {
		try {
