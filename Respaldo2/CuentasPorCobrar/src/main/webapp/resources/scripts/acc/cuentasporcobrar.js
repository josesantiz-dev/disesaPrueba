...
function timbrar(operacionCancelada, pnlOperacion, pnlMensajes, validador) {
	...
	console.log('validando campos requeridos ... ');
	if (campos_requeridos(validador)) {
		console.log('REQUERIDOS ... exit\n------------------------------');
		return;
	}

	console.log('campos requeridos validados!');
	console.log((operacionCancelada ? 'ERROR' : 'OK') + ' ... mostrando mensaje');
	//RichFaces.ui.PopupPanel.showPopupPanel(pnlMensajes);
	if (operacionCancelada == false) {
		console.log('Ejecutando: RichFaces.ui.PopupPanel.hidePopupPanel("' + pnlOperacion + '");');
		RichFaces.ui.PopupPanel.hidePopupPanel(pnlOperacion);
	}
	console.log('exit timbrar\n------------------------------');
}
