...
public interface LlavesDAO extends DAO<Llaves> {
	...
	public long save(Llaves entity, Long idEmpresa) throws Exception;
	
	public List<Llaves> saveOrUpdateList(List<Llaves> entities, Long idEmpresa) throws Exception;
