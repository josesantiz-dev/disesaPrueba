...
public interface OperacionesIntegradasConceptosSqlDAO extends DAO<OperacionesIntegradasConceptosSql> {
	...
	public long save(OperacionesIntegradasConceptosSql entity, Long idEmpresa) throws Exception;
	
	public List<OperacionesIntegradasConceptosSql> saveOrUpdateList(List<OperacionesIntegradasConceptosSql> entities, Long idEmpresa) throws Exception;
