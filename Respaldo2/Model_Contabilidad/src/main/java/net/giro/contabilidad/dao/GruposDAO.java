...
public interface GruposDAO extends DAO<Grupos> {
	...
	public long save(Grupos entity, Long idEmpresa) throws Exception;
	
	public List<Grupos> saveOrUpdateList(List<Grupos> entities, Long idEmpresa) throws Exception;
