...
public interface PolizasInterfacesDAO extends DAO<PolizasInterfaces> {
	...
	public long save(PolizasInterfaces entity, Long idEmpresa) throws Exception;
	
	public List<PolizasInterfaces> saveOrUpdateList(List<PolizasInterfaces> entities, Long idEmpresa) throws Exception;
