...
public interface OperacionesIntegradasDAO extends DAO<OperacionesIntegradas> {
	...
	public long save(OperacionesIntegradas entity, Long idEmpresa) throws Exception;
	
	public List<OperacionesIntegradas> saveOrUpdateList(List<OperacionesIntegradas> entities, Long idEmpresa) throws Exception;
