...
public class OperacionesIntegradasSqlImp extends DAOImpl<OperacionesIntegradasSql> implements OperacionesIntegradasSqlDAO {
	...
	public List<OperacionesIntegradasSql> findByProperty(String propertyName, Object value, int limite) throws Exception {
		String queryString = "select model from OperacionesIntegradasSql model where model.idEmpresa = :idEmpresa and model.idOperacionIntegradaTransaccion.estatus = 0";
