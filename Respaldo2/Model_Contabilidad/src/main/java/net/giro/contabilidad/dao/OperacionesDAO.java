...
public interface OperacionesDAO extends DAO<Operaciones> {
	...
	public long save(Operaciones entity, Long idEmpresa) throws Exception;
	
	public List<Operaciones> saveOrUpdateList(List<Operaciones> entities, Long idEmpresa) throws Exception;
