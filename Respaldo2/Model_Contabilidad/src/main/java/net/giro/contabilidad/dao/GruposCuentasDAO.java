...
public interface GruposCuentasDAO extends DAO<GruposCuentas> {
	...
	public long save(GruposCuentas entity, Long idEmpresa) throws Exception;
	
	public List<GruposCuentas> saveOrUpdateList(List<GruposCuentas> entities, Long idEmpresa) throws Exception;
