...
public interface ConceptosDAO extends DAO<Conceptos> {
	...
	public long save(Conceptos entity, Long idEmpresa) throws Exception;
	
	public List<Conceptos> saveOrUpdateList(List<Conceptos> entities, Long idEmpresa) throws Exception;
