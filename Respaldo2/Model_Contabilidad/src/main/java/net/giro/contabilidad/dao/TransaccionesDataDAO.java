...
public interface TransaccionesDataDAO extends DAO<TransaccionesData> {
	...
	public long save(TransaccionesData entity, Long idEmpresa) throws Exception;
	
	public List<TransaccionesData> saveOrUpdateList(List<TransaccionesData> entities, Long idEmpresa) throws Exception;
