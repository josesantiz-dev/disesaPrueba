...
public class NegociosFac implements NegociosRem {
	...
	public Long save(Negocio entity) throws Exception {
		try {
			return this.ifzNegocio.save(entity, getIdEmpresa());
		} catch (Exception e) {
			log.error("error en Logica_Publico.FACADE.save(Negocio)", e);
			throw e;
		}
	}
	...
	public List<Negocio> saveOrUpdateList(List<Negocio> entities) throws Exception {
		try {
			return this.ifzNegocio.saveOrUpdateList(entities, getIdEmpresa());
		} catch (Exception e) {
			log.error("error en Logica_Publico.FACADE.saveOrUpdateList(List<Negocio> entities)", e);
			throw e;
		}
	}
	...
	public Respuesta buscarDomicilio(long idNegocio) throws Exception {
		...
		try {
			...
			lista = this.ifzClientes.buscarDomicilioExt(this.findById(idNegocio)); 
