...
public class PersonaEstudioExt implements java.io.Serializable {
	...
	long aniosEstudio;
	Boolean terminoEstudio;
	java.lang.Long carrera;
	java.lang.String escuela;
	java.util.Date fechaIngreso;
	java.util.Date fechaEgreso;
	
	public PersonaEstudioExt(){
		
	}
	
	public PersonaEstudioExt(long id, long creadoPor, Date fechaCreacion,
			long modificadoPor, Date fechaModificacion, Persona persona,
			Long estudio, long aniosEstudio, Boolean terminoEstudio,
			Long carrera, String escuela, Date fechaIngreso, Date fechaEgreso) {
		this.id = id;
	...
	public Boolean getTerminoEstudio() {
		return terminoEstudio;
	}

	public void setTerminoEstudio(Boolean terminoEstudio) {
		this.terminoEstudio = terminoEstudio;
	}
