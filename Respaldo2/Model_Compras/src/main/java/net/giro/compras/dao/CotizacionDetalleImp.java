...
@Stateless
public class CotizacionDetalleImp extends DAOImpl<CotizacionDetalle> implements CotizacionDetalleDAO {
	@PersistenceContext
	...
	public void OrderBy(String orderBy) {
		CotizacionDetalleImp.orderBy = orderBy;
	}
	...
	public List<CotizacionDetalle> findByProperty(String propertyName, Object value, int max) throws Exception {
		String queryString = "select model from CotizacionDetalle model ";
 ...
 * ---------------------------------------------------------------------------------------------------------------- 
 * 2.2 | 2017-06-21 | Javier Tirado 	| Implemento los metodos findByProperties y findLikeProperties
 */