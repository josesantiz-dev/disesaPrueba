...
@Stateless
public class RequisicionDetalleImp extends DAOImpl<RequisicionDetalle> implements RequisicionDetalleDAO {
	@PersistenceContext
	...
	public void OrderBy(String orderBy) {
		RequisicionDetalleImp.orderBy = orderBy;
	}
	...
	public List<RequisicionDetalle> findByProperty(String propertyName, Object value, int max) throws Exception {
		String queryString = "select model from RequisicionDetalle model ";
