...
public class OperacionesIntegradasTransaccionesAction implements Serializable {
	...
	public OperacionesIntegradasTransaccionesAction() {
		...
		try {
			...
			this.ifzOperIntegradasSQL.setInfoSesion(this.loginManager.getInfoSesion());
	...
	public void buscar() {
		try {
			...
			control("Ocurrio un problema al consultar las Operacion Integradas Transacciones", e);
		}
	}
	...
	public void nuevo() {
		try {
			...
			control("Ocurrio un problema al intentar generar una nueva Operacion Integrada Transaccion", e);
		}
	}
	...
	public void editar() {
		...
		try {
			...
			control("Ocurrio un problema al intentar editar la Operacion Integrada Transaccion seleccionada", e);
		}
	}
	...
	public void cargarOperacionIntegradasConceptosSQL() throws Exception {
		...
		// Cargamos los datos
		this.listOperIntegradasConceptosSql = this.ifzOperIntegradasConceptosSQL.findByProperty("idOperacionIntegradaTransaccion", this.pojoOperacion, 1000);
		if (this.listOperIntegradasConceptosSql != null && ! this.listOperIntegradasConceptosSql.isEmpty()) {
	...
	public void cargarOperacionIntegradasSQL() throws Exception {
		...
		// Cargamos los datos
		this.listOperIntegradasSQL = this.ifzOperIntegradasSQL.findByProperty("idOperacionIntegradaTransaccion", this.pojoOperacion, 1000);
		if (this.listOperIntegradasSQL != null && ! this.listOperIntegradasSQL.isEmpty()) {
			Collections.sort(this.listOperIntegradasSQL, new Comparator<OperacionesIntegradasSql>() {
				@Override
