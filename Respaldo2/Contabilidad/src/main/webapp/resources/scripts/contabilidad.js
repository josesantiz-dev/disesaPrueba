...
function seleccionar(operacionCancelada, pnlOperacion, pnlMensajes) {
	console.log('------------------------------');
	console.log('function seleccionar(operacionCancelada, pnlOperacion, pnlMensajes)');
...
function seleccionarConfirmar(operacionCancelada, pnlOperacion, pnlMensajes, confirmar, pnlConfirmar) {
	seleccionar(operacionCancelada, pnlOperacion, pnlMensajes);

	console.log('         ------------        ');
	console.log('function seleccionarConfirmar(... confirmar, pnlMensajes)');
	console.log('          confirmar : ' + confirmar);
	console.log('       pnlConfirmar : ' + pnlConfirmar);
	
	if (confirmar == true)
		RichFaces.ui.PopupPanel.showPopupPanel(pnlConfirmar);
	console.log('function seleccionarConfirmar DONE\n------------------------------');
}
