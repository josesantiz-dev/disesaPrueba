...
public class PuestoCategoriaAction implements Serializable  {
		...
		try{
			if ( this.pojoPuestoCategoria.getId() == null ) {
				if( pojoPuesto.getId() != null && pojoCategoria.getId() != null) {
					...
					if (!this.ifzPuestoCategoria.findByPuestoCategoria(pojoPuesto.getId(), pojoCategoria.getId()).isEmpty()){
					...
					puestoCategoria.setCreadoPor(this.usuarioId);
					puestoCategoria.setFechaCreacion( Calendar.getInstance().getTime() );
					puestoCategoria.setModificadoPor(this.usuarioId);
					puestoCategoria.setFechaModificacion( Calendar.getInstance().getTime() );
					puestoCategoria.setIdPuesto(this.pojoPuesto);
					puestoCategoria.setIdCategoria(this.pojoCategoria);
	...
	public void setPojoPuestoCategoria(PuestoCategoria pojoPuestoCategoria) {
		...
		this.pojoPuesto = pojoPuestoCategoria.getIdPuesto();
		this.pojoCategoria = pojoPuestoCategoria.getIdCategoria();
		
		this.idNuevoPuesto = pojoPuestoCategoria.getIdPuesto().getId();
		this.idNuevaCategoria = pojoPuestoCategoria.getIdCategoria().getId();
