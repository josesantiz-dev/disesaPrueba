...
function validarGuardado(listErrores,pnl1,pnl2,v_bool,invocacion, resultado, pnlError){
	...
	if(invocacion == 'guardar'){
		if(v_bool==true){
			...
			console.log('---> on guardar :: v_bool=true');
		}else{
			RichFaces.ui.PopupPanel.hidePopupPanel(pnl1);
			RichFaces.ui.PopupPanel.showPopupPanel(pnl2);
			console.log('---> on guardar :: v_bool=false');
		}
	}
