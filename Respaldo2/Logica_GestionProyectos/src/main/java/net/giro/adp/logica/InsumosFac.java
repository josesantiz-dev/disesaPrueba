...
public class InsumosFac implements InsumosRem {
	...
	public Long save(Insumos entity) throws Exception {
		try {
			this.ifzInsumos.setEmpresa(getIdEmpresa());
	...
	public List<Insumos> saveOrUpdateList(List<Insumos> entities) throws Exception {
		try {
			this.ifzInsumos.setEmpresa(getIdEmpresa());
			return this.ifzInsumos.saveOrUpdateList(entities);
		} catch (Exception e) {
	...
	public Long save(InsumosExt entityExt) throws Exception {
		try {
			return this.save(this.convertidor.InsumosExtToInsumos(entityExt));
		} catch (Exception e) {
	...
	public void update(InsumosExt entityExt) throws Exception {
		try {
			this.update(this.convertidor.InsumosExtToInsumos(entityExt));
		} catch (Exception e) {
	...
	public List<InsumosExt> findExtByActivos(int max){
		...
		try {
			List<Insumos> lista = this.findByActivos(max);
	...
	private Respuesta leerEXCEL(byte[] fileSrc, HashMap<String, String> layoutReference) throws Exception {
		...
		try {
			...
			this.layoutReference = layoutReference; //procesaLayout(layoutReference);
