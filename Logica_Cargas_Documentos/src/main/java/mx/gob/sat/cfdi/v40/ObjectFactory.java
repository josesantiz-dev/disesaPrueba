 ...
 * generated in the net.disesa.data.factura.test package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.disesa.data.factura.test
     * 
     */
