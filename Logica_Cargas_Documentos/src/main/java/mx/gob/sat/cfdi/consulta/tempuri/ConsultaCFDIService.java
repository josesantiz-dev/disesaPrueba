...
public class ConsultaCFDIService extends Service {
     ...
     *     returns IConsultaCFDIService
     */
    @WebEndpoint(name = "BasicHttpsBinding_IConsultaCFDIService")
    public IConsultaCFDIService getBasicHttpsBindingIConsultaCFDIService() {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpsBinding_IConsultaCFDIService"), IConsultaCFDIService.class);
    }
     ...
     */
    @WebEndpoint(name = "BasicHttpsBinding_IConsultaCFDIService")
    public IConsultaCFDIService getBasicHttpsBindingIConsultaCFDIService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "BasicHttpsBinding_IConsultaCFDIService"), IConsultaCFDIService.class, features);
    }
