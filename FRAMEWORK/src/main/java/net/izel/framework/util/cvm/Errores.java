package net.izel.framework.util.cvm;
...
public class Errores { 
	...
	public static final long  ERROR_NO_EXISTE_TRANSACCION= 17;
	public static final long  ERROR_OBTENER_TRANSACCION= 18;
	public static final long  ERROR_ANULAR_TRANSACCION= 19;
	public static final long  ERROR_ANULAR_TRANSACCION_CALLS= 20;
	...
	static {
		...
		descError.put(ERROR_NO_EXISTE_TRANSACCION,"Error no se encontro la transaccion");
		descError.put(ERROR_OBTENER_TRANSACCION,"Error al obtener la transaccion");
		descError.put(ERROR_ANULAR_TRANSACCION,"Error al anular la transaccion");
		descError.put(ERROR_ANULAR_TRANSACCION_CALLS,"Error llamar la funcion anulaTransaccion");
