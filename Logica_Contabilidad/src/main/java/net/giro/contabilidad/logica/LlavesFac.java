...
public class LlavesFac implements LlavesRem {
	...
	public Long save(Llaves entity) throws Exception {
		try {
			return this.ifzLlaves.save(entity, getCodigoEmpresa());
		} catch (Exception e) {
	...
	public List<Llaves> saveOrUpdateList(List<Llaves> entities) throws Exception {
		try {
			return this.ifzLlaves.saveOrUpdateList(entities, getCodigoEmpresa());
		} catch (Exception e) {
			log.error("error en Logica_Contabilidad.LlavesFac.save(Llaves)", e);
			throw e;
		}
	...
	public List<Llaves> findByProperty(String propertyName, Object value, int limite) throws Exception {
		try {
			...
			return this.ifzLlaves.findByProperty(propertyName, value, getIdEmpresa(), limite);
		} catch (Exception e) {
			log.error("error en Logica_Contabilidad.LlavesFac.findByProperty(propertyName, value, limite)", e);
			throw e;
		} finally {
			orderBy = null;
		}
	...
	public List<Llaves> findLikeProperty(String propertyName, Object value, int limite) throws Exception {
		try {
			this.ifzLlaves.orderBy(orderBy);
			return this.ifzLlaves.findLikeProperty(propertyName, value, getIdEmpresa(), limite);
		} catch (Exception e) {
			log.error("error en Logica_Contabilidad.LlavesFac.findLikeProperty(propertyName, value, limite)", e);
			throw e;
		} finally {
			orderBy = null;
		}
	...
	public List<Llaves> findInProperty(String columnName, List<Object> values, int limite) throws Exception {
		try {
			this.ifzLlaves.orderBy(orderBy);
			return this.ifzLlaves.findInProperty(columnName, values, getIdEmpresa(), limite);
		} catch (Exception e) {
	...
	public List<Llaves> findByProperties(HashMap<String, String> params, int limite) throws Exception {
		try {
			this.ifzLlaves.orderBy(orderBy);
			return this.ifzLlaves.findByProperties(params, getIdEmpresa(), limite);
		} catch (Exception e) {
	...
	public boolean comprobarPosicion(Long idLlave, int posicion) throws Exception {
		try {
			return this.ifzLlaves.comprobarPosicion(idLlave, posicion, getIdEmpresa());
		} catch (Exception e) {
