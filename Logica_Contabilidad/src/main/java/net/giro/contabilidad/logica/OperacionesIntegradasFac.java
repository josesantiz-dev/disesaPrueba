...
public class OperacionesIntegradasFac implements OperacionesIntegradasRem {
	...
	public Long save(OperacionesIntegradas entity) throws Exception {
		try {
			return this.ifzOIntegradas.save(entity, getCodigoEmpresa());
		} catch (Exception e) {
	...
	public List<OperacionesIntegradas> saveOrUpdateList(List<OperacionesIntegradas> entities) throws Exception {
		try {
			return this.ifzOIntegradas.saveOrUpdateList(entities, getCodigoEmpresa());
		} catch (Exception e) {
	...
	public List<OperacionesIntegradas> findByProperty(String propertyName, Object value, int limite) throws Exception {
		try {
			...
			return this.ifzOIntegradas.findByProperty(propertyName, value, getIdEmpresa(), limite);
		} catch (Exception e) {
			log.error("error en Logica_Contabilidad.OperacionesIntegradasFac.findByProperty(propertyName, value, limite)", e);
			throw e;
		} finally {
			orderBy = null;
		}
	...
	public List<OperacionesIntegradas> findLikeProperty(String propertyName, Object value, int limite) throws Exception {
		try {
			this.ifzOIntegradas.orderBy(orderBy);
			return this.ifzOIntegradas.findLikeProperty(propertyName, value, getIdEmpresa(), limite);
		} catch (Exception e) {
			log.error("error en Logica_Contabilidad.OperacionesIntegradasFac.findLikeProperty(propertyName, value, limite)", e);
			throw e;
		} finally {
			orderBy = null;
		}
	...
	public List<OperacionesIntegradas> findInProperty(String columnName, List<Object> values, int limite) throws Exception {
		try {
			this.ifzOIntegradas.orderBy(orderBy);
			return this.ifzOIntegradas.findInProperty(columnName, values, getIdEmpresa(), limite);
		} catch (Exception e) {
	...
	public List<OperacionesIntegradas> findByProperties(HashMap<String, String> params, int limite) throws Exception {
		try {
			this.ifzOIntegradas.orderBy(orderBy);
			return this.ifzOIntegradas.findByProperties(params, getIdEmpresa(), limite);
		} catch (Exception e) {
