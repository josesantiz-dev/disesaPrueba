...
public class PresupuestoFac implements PresupuestoRem {
	...
	public Long save(Presupuesto entity) throws Exception {
		try {
			return this.ifzPresupuesto.save(entity, getCodigoEmpresa());
		} catch (Exception e) {
	...
	public List<Presupuesto> saveOrUpdateList(List<Presupuesto> entities) throws Exception {
		try {
			return this.ifzPresupuesto.saveOrUpdateList(entities, getCodigoEmpresa());
		} catch (Exception e) {
			log.error("Error en PresupuestoFac.saveOrUpdateList(List<Presupuesto> entities)", e);
			throw e;
		}
	}
	...
	public Presupuesto findById(Long idPresupuesto) {
		try {
			return this.ifzPresupuesto.findById(idPresupuesto);
		} catch (Exception e) {
			log.error("Error en PresupuestoFac.findById(idPresupuesto)", e);
			throw e;
		}
	}
	...
	public Presupuesto findActual(long idObra) {
		try {
			return this.ifzPresupuesto.findActual(idObra, getIdEmpresa());
		} catch (Exception e) {
			log.error("Error en PresupuestoFac.findActual(idObra)", e);
			throw e;
		}
	}
	...
	public List<Presupuesto> findAll(long idObra) {
		try {
			return this.findAll(idObra, 0);
		} catch (Exception e) {
			log.error("Error en PresupuestoFac.findAll(idObra)", e);
			throw e;
		}
	}
	...
	public List<Presupuesto> findAll(long idObra, int limite) {
		try {
			return this.ifzPresupuesto.findAll(idObra, getIdEmpresa(), limite);
		} catch (Exception e) {
			log.error("Error en PresupuestoFac.findAll(idObra, limite)", e);
			throw e;
		}
	}
	...
	public List<Presupuesto> findByProperty(String propertyName, Object value, int max) {
		try {
			return this.ifzPresupuesto.findByProperty(propertyName, value, getIdEmpresa(), max);
		} catch (Exception e) {
	...
	public List<Presupuesto> findLikeProperty(String propertyName, Object value, int max) {
		try {
			return this.ifzPresupuesto.findLikeProperty(propertyName, value, getIdEmpresa(), max);
		} catch (Exception e) {
	...
	public PresupuestoExt findByIdExt(Long idPresupuesto) throws Exception {
		try {
			return this.convertidor.getExtendido(this.findById(idPresupuesto));
		} catch (Exception e) {
	...
	public PresupuestoExt findActualExt(long idObra) throws Exception {
		try {
			...
			log.error("Error en PresupuestoFac.findActualExt(idObra)", e);
			throw e;
		}
	}
	...
	public List<PresupuestoExt> findAllExt() throws Exception {
		List<PresupuestoExt> extendidos = new ArrayList<PresupuestoExt>();
		List<Presupuesto> entities = null;
		
		try {
			entities = this.findAll();
			if (entities == null || entities.isEmpty())
				return extendidos;
			for (Presupuesto entity : entities)
				extendidos.add(this.convertidor.getExtendido(entity));
		} catch (Exception e) {
			log.error("Error en InsumosFac.findAllExt()", e);
			throw e;
		}
	...
	public List<PresupuestoExt> findAllExt(long idObra) throws Exception {
		...
		try {
			entities = this.findAll(idObra);
			if (entities == null || entities.isEmpty())
				return extendidos;
			for (Presupuesto entity : entities)
				extendidos.add(this.convertidor.getExtendido(entity));
		} catch (Exception e) {
			log.error("Error en InsumosFac.findAllExt(idObra)", e);
			throw e;
		}
