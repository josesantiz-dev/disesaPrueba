...
public class ConvertExt {
	...
	public ConvertExt() {
		...
		try {
    		...
    		this.ifzNegocios = (NegocioDAO) ctx.lookup("ejb:/Model_Clientes//NegocioImp!net.giro.clientes.dao.NegocioDAO");
    		...
    		this.ifzConceptoPresupuesto = (ConceptoPresupuestoRem) ctx.lookup("ejb:/Logica_GestionProyectos//ConceptoPresupuestoFac!net.giro.adp.logica.ConceptoPresupuestoRem");
    		
    		this.from = "default";
    		this.mostrarSystemOut = false;
		} catch (Exception e) {
			log.error("Ocurrio un problema al intanciar " + this.getClass().getCanonicalName(), e);
		}
	}
	...
	public Persona NegocioToPersona(Negocio pojoNegocio) {
		...
		try {
			...
			log.error(this.getClass().getCanonicalName() + " :: ERROR al convertir Negocio To Persona", e);
			throw e;
		}
	...
	public PersonaExt PersonaToPersonaExt(Persona pojoTarget) throws Exception {
		...
		if (pojoTarget.getEstadoCivil() != null)
			pojoResult.setEstadoCivil(this.ifzConValores.findById(pojoTarget.getEstadoCivil()));
		
		if (pojoTarget.getLocalidad() != null)
			pojoResult.setLocalidad(this.ifzLocalidad.findById(pojoTarget.getLocalidad()));
		
		if (pojoTarget.getNacionalidad () != null)
			pojoResult.setNacionalidad(this.ifzConValores.findById(pojoTarget.getNacionalidad()));
		...
		if (pojoTarget.getTipoSangre() != null)
			pojoResult.setTipoSangre(this.ifzConValores.findById(pojoTarget.getTipoSangre()));
		
		if (pojoTarget.getColonia() != null)
			pojoResult.setColonia(this.ifzColonia.findById(pojoTarget.getColonia()));
	...
	public Obra getPojo(ObraExt pojoTarget) {
		...
		try {
			...
			pojoResult.setRfcCliente(pojoTarget.getRfcCliente());
			pojoResult.setMontoContratado(pojoTarget.getMontoContratado());
			pojoResult.setTipoCambioAnticipo(pojoTarget.getTipoCambioAnticipo());
			pojoResult.setMontoAnticipo(pojoTarget.getMontoAnticipo());
			pojoResult.setPorcentajeAnticipo(pojoTarget.getPorcentajeAnticipo());
			pojoResult.setTipoCambioDeductiva(pojoTarget.getTipoCambioDeductiva());
			...
			pojoResult.setFechaEstatus(pojoTarget.getFechaEstatus());
			...
			if (pojoTarget.getIdCliente() != null && pojoTarget.getIdCliente().getId() > 0) {
				...
				pojoResult.setRfcCliente(pojoTarget.getIdCliente().getRfc());
			...
			if (pojoTarget.getIdResponsable() != null && pojoTarget.getIdResponsable().getId() != null && pojoTarget.getIdResponsable().getId() > 0) {
			...
			log.error(this.getClass().getCanonicalName() + " :: ERROR al convertir ObraExt To Obra :: " + ex);
			throw ex;
		}
	...
	public ObraExt getExtendido(Obra pojoTarget) throws Exception {
		...
		try {
			...
			if (pojoTarget.getIdObraPrincipal() != null && pojoTarget.getIdObraPrincipal() > 0) {
				...
				pojoObra = (pojoObra != null ? pojoObra : new Obra());
			...
			if (pojoTarget.getIdCliente() > 0) {
				...
				if (pojoTarget.getTipoCliente() == null || "P".equals(pojoTarget.getTipoCliente())) {
					...
					pojoPersona = (pojoPersona != null ? pojoPersona : new Persona());
					...
					pojoNegocio = (pojoNegocio != null ? pojoNegocio : new Negocio());
				...
				if (pojoResult.getRfcCliente() == null || "".equals(pojoResult.getRfcCliente()))
					pojoResult.setRfcCliente(pojoPersona.getRfc());
			...
			if (pojoTarget.getIdSucursal() != null && pojoTarget.getIdSucursal() > 0) {
				...
				pojoAux = (pojoAux != null ? pojoAux : new Sucursal());
			...
			if (pojoTarget.getIdResponsable() != null && pojoTarget.getIdResponsable() > 0) {
				...
				pojoAux = (pojoAux != null ? pojoAux : new EmpleadoExt());
				pojoResult.setIdResponsable(pojoAux);
				if (this.mostrarSystemOut) log.info("---- -- ----> Comprobando Responsable terminado");
			}
		} catch (Exception ex) {
			log.error(this.getClass().getCanonicalName() + " :: ERROR al convertir Obra To ObraExt :: ", ex);
			throw ex;
		}
	...
	public ObraEmpleado getPojo(ObraEmpleadoExt pojoTarget) {
		...
		try {
			...
			if (pojoTarget.getIdObra() != null && pojoTarget.getIdObra().getId() != null && pojoTarget.getIdObra().getId() > 0L) 
				pojoResult.setIdObra(getPojo(pojoTarget.getIdObra()));
	...
	public ObraEmpleadoExt getExtendido(ObraEmpleado pojoTarget) throws Exception {
		...
		try {
			...
			if (this.mostrarSystemOut) log.info("---- -- ----> Comprobando Obra");
			if (pojoTarget.getIdObra() != null && pojoTarget.getIdObra().getId() != null && pojoTarget.getIdObra().getId() > 0L) 
				pojoResult.setIdObra(getExtendido(pojoTarget.getIdObra()));
	...
	public Insumos getPojo(InsumosExt pojoTarget) {
		...
		try {
			...
			pojoResult.setTotalEquipos(pojoTarget.getMontoEquipos());
	...
	public InsumosExt getExtendido(Insumos pojoTarget) throws Exception {
		...
		try {
			...
			pojoResult.setMontoEquipos(pojoTarget.getTotalEquipos());
	...
	public InsumosDetalles getPojo(InsumosDetallesExt pojoTarget) {
	...
	public InsumosDetallesExt getExtendido(InsumosDetalles pojoTarget) throws Exception {
		...
		try {
			...
			if(pojoTarget.getIdInsumo() != null && pojoTarget.getIdInsumo() > 0L) {
				...
				pojoAux = (pojoAux != null ? pojoAux : new InsumosExt());
			...
			if(pojoTarget.getIdProducto() != null && pojoTarget.getIdProducto() > 0L) {
				...
				pojoAux = (pojoAux != null ? pojoAux : new ProductoExt());
	...
	public Presupuesto getPojo(PresupuestoExt pojoTarget) {
	...
	public PresupuestoExt getExtendido(Presupuesto pojoTarget) throws Exception {
	...
	public PresupuestoDetalle getPojo(PresupuestoDetalleExt pojoTarget) {
	...
	public PresupuestoDetalleExt getExtendido(PresupuestoDetalle pojoTarget) {
	...
	public ObraAlmacenes getPojo(ObraAlmacenesExt pojoTarget) {
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: From " + this.from + " ::  ObraAlmacenesExtToObraAlmacenes");
		...
		try {
			...
			log.error(this.getClass().getCanonicalName() + " :: ERROR al convertir ObraAlmacenesExtToObraAlmacenes :: ", ex);
			throw ex;
		}
		
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: ObraAlmacenesExtToObraAlmacenes :: Conversion terminada :: " + pojoTarget.getId() + "|" + pojoResult.getId());
		
		return pojoResult;
	}

	public ObraAlmacenesExt getExtendido(ObraAlmacenes pojoTarget) throws Exception {
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: From " + this.from + " ::  ObraAlmacenesToObraAlmacenesExt");
		...
		try {
			...
			if (this.mostrarSystemOut) log.info("---- -- ----> Comprobando Obra");
			if (pojoTarget.getIdAlmacen() > 0L) {
				Almacen pojoAux = this.ifzAlmacenes.findById(pojoTarget.getIdAlmacen());
				pojoAux = (pojoAux != null ? pojoAux : new Almacen());
				pojoResult.setIdAlmacen(pojoAux);
				if (this.mostrarSystemOut) log.info("---- -- ----> Comprobando Obra terminado");
			}
		} catch (Exception ex) {
			log.error(this.getClass().getCanonicalName() + " :: ERROR al convertir ObraAlmacenesToObraAlmacenesExt :: ", ex);
			throw ex;
		}
		
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: ObraAlmacenesToObraAlmacenesExt :: Conversion terminada :: " + pojoTarget.getId() + "|" + pojoResult.getId());
	...
	public ObraSubcontratista getPojo(ObraSubcontratistaExt pojoTarget) {
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: From " + this.from + " ::  ObraSubcontratistaExtToObraSubcontratista");
		ObraSubcontratista pojoResult = null;
		...
		try {
			...
			pojoResult.setTotalOrdenCompra(pojoTarget.getTotalOrdenCompra());
			pojoResult.setSaldoOrdenCompra(pojoTarget.getSaldoOrdenCompra());
			pojoResult.setIdMoneda(pojoTarget.getIdMoneda());
			pojoResult.setMoneda(pojoTarget.getMoneda());
			pojoResult.setTipoCambio(pojoTarget.getTipoCambio());
			pojoResult.setPorcentajeAnticipo(pojoTarget.getPorcentajeAnticipo());
			...
			pojoResult.setEstimacion(pojoTarget.getEstimacion());
			pojoResult.setAmortizacion(pojoTarget.getAmortizacion());
			pojoResult.setFondoGarantia(pojoTarget.getFondoGarantia());
			...
			pojoResult.setCargos(pojoTarget.getCargos());
			pojoResult.setTotal(pojoTarget.getTotal());
			// -----------------------------------------------------------------------------------------------------------
			pojoResult.setIdFactura(pojoTarget.getIdFactura());
			...
			pojoResult.setFacturaTotal(pojoTarget.getFacturaTotal());
			pojoResult.setFacturaTotalPesos(pojoTarget.getFacturaTotalPesos());
			// -----------------------------------------------------------------------------------------------------------
			pojoResult.setIdEmpresa(pojoTarget.getIdEmpresa());
			pojoResult.setEstatus(pojoTarget.getEstatus());
			pojoResult.setCreadoPor(pojoTarget.getCreadoPor());
			...
			log.error(this.getClass().getCanonicalName() + " :: ERROR al convertir ObraSubcontratistaExtToObraSubcontratista :: ", ex);
			throw ex;
		}
		
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: ObraSubcontratistaExtToObraSubcontratista :: Conversion terminada :: " + pojoTarget.getId() + "|" + pojoResult.getId());
		
		return pojoResult;
	}
	
	public ObraSubcontratistaExt getExtendido(ObraSubcontratista pojoTarget) {
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: From " + this.from + " ::  ObraAlmacenesExtToObraAlmacenes");
		ObraSubcontratistaExt pojoResult = null;
		...
		try {
			...
			pojoResult.setModificadoPor(pojoTarget.getModificadoPor());
			pojoResult.setFechaModificacion(pojoTarget.getFechaModificacion());
			if (pojoResult.getId() != null && pojoResult.getId() > 0L) 
				pojoResult.setNuevo(false);
			if (this.mostrarSystemOut) log.info("---- -- ----> Comprobando de tipos nativos terminado");
		} catch (Exception ex) {
			log.error(this.getClass().getCanonicalName() + " :: ERROR al convertir ObraAlmacenesExtToObraAlmacenes :: ", ex);
			throw ex;
	...
	public ObraSubcontratistaImpuestos getPojo(ObraSubcontratistaImpuestosExt pojoTarget) {
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: From " + this.from + " ::  ObraSubcontratistaImpuestosExtToObraSubcontratistaImpuestos");
		ObraSubcontratistaImpuestos pojoResult = null;
		...
		try {
			...
			if (this.mostrarSystemOut) log.info("---- -- ----> Comprobando de tipos nativos");
			pojoResult = new ObraSubcontratistaImpuestos();
			pojoResult.setId(pojoTarget.getId());
			pojoResult.setIdObraSubcontratista(pojoTarget.getIdObraSubcontratista());
			pojoResult.setIdImpuesto(pojoTarget.getIdImpuesto());
			pojoResult.setNombreImpuesto(pojoTarget.getNombreImpuesto());
			pojoResult.setTasaImpuesto(pojoTarget.getTasaImpuesto());
			pojoResult.setBaseImpuesto(pojoTarget.getBaseImpuesto());
			pojoResult.setImporte(pojoTarget.getImporte());
			pojoResult.setRetencion(pojoTarget.getRetencion());
			pojoResult.setExcluir(pojoTarget.getExcluir());
			// -----------------------------------------------------------------------------------------------------------
			pojoResult.setCreadoPor(pojoTarget.getCreadoPor());
			pojoResult.setFechaCreacion(pojoTarget.getFechaCreacion());
			pojoResult.setModificadoPor(pojoTarget.getModificadoPor());
		...
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: ObraSubcontratistaImpuestosExtToObraSubcontratistaImpuestos :: Conversion terminada :: " + pojoTarget.getId() + "|" + pojoResult.getId());
		
		return pojoResult;
	}
	
	public ObraSubcontratistaImpuestosExt getExtendido(ObraSubcontratistaImpuestos pojoTarget) {
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: From " + this.from + " ::  ObraSubcontratistaImpuestosToObraSubcontratistaImpuestosExt");
		ObraSubcontratistaImpuestosExt pojoResult = null;
		...
		try {
			...
			if (this.mostrarSystemOut) log.info("---- -- ----> Comprobando de tipos nativos");
			pojoResult = new ObraSubcontratistaImpuestosExt();
			pojoResult.setId(pojoTarget.getId());
			pojoResult.setIdObraSubcontratista(pojoTarget.getIdObraSubcontratista());
			pojoResult.setIdImpuesto(pojoTarget.getIdImpuesto());
			pojoResult.setNombreImpuesto(pojoTarget.getNombreImpuesto());
		...
		if (this.mostrarSystemOut) log.info(this.getClass().getCanonicalName() + " :: ObraSubcontratistaImpuestosToObraSubcontratistaImpuestosExt :: Conversion terminada :: " + pojoTarget.getId() + "|" + pojoResult.getId());
