...
function evaluaCancelar(operacionCancelada, tipoMensaje, pnlConfirmar, pnlCancelar, pnlMensajes) {
	console.log('------------------------------');
	console.log('function evaluaCancelar(operacionCancelada, tipoMensaje, pnlConfirmar, pnlCancelar, pnlMensajes)\n');
	console.log('  operacionCancelada : ' + operacionCancelada);
