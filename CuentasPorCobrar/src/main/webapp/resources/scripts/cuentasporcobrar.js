...
function buscar3(operacionCancelada, pnlMensajes) {
	console.log('\n------------------------------\nfunction buscar3(operacionCancelada, pnlMensajes)\n');
	console.log('operacionCancelada : ' + operacionCancelada);
	console.log('pnlMensajes        : ' + pnlMensajes);
...
function evaluaCancelar(operacionCancelada, pnlOperacion, pnlMensajes) {
	console.log('------------------------------');
	console.log('function evaluaCancelar(operacionCancelada, pnlOperacion, pnlMensajes)\n');
	console.log('operacionCancelada : ' + operacionCancelada);
	console.log('pnlOperacion       : ' + pnlOperacion);
	console.log('pnlMensajes        : ' + pnlMensajes);

	if (operacionCancelada == true) {
		console.log('function evaluaCancelar ERROR\n------------------------------');
		RichFaces.ui.PopupPanel.showPopupPanel(pnlMensajes);
		return;
	}

	RichFaces.ui.PopupPanel.showPopupPanel(pnlOperacion);
	console.log('function evaluaCancelar DONE\n------------------------------');
}

function evaluaCancelar2(operacionCancelada, tipoMensaje, pnlConfirmar, pnlCancelar, pnlMensajes) {
	console.log('------------------------------');
	console.log('function evaluaCancelar2(operacionCancelada, tipoMensaje, pnlConfirmar, pnlCancelar, pnlMensajes)\n');
	console.log('  operacionCancelada : ' + operacionCancelada);
	console.log('  tipoMensaje        : ' + tipoMensaje);
	console.log('  pnlConfirmar       : ' + pnlConfirmar);
	console.log('  pnlCancelar        : ' + pnlCancelar);
	console.log('  pnlMensajes        : ' + pnlMensajes);
...
function seleccionar2(operacionCancelada, pnlOperacion, pnlMensajes, multiSeleccion) {
	console.log('------------------------------');
	console.log('function seleccionar2(operacionCancelada, pnlOperacion, pnlMensajes, multiSeleccion)');
	console.log('    operacionCancelada : ' + operacionCancelada);
	console.log('    pnlOperacion       : ' + pnlOperacion);
	console.log('    pnlMensajes        : ' + pnlMensajes);
...
function cancelarPago(operacionCancelada, pnlOperacion, pnlMensajes) {
	console.log('------------------------------');
	console.log('function cancelarPago(operacionCancelada, pnlOperacion, pnlMensajes)\n');
	console.log('  operacionCancelada : ' + operacionCancelada);
	console.log('  pnlOperacion       : ' + pnlOperacion);
	console.log('  pnlMensajes        : ' + pnlMensajes);
...
function eliminarFacturaRefacturar(operacionCancelada, refacturar, pnlOperacion, pnlMensajes) {
	console.log('------------------------------');
	console.log('eliminarFacturaRefacturar(operacionCancelada, refacturar, pnlOperacion, pnlMensajes)\n');
	console.log('operacionCancelada : ' + operacionCancelada);
	console.log('        refacturar : ' + refacturar);
	console.log('      pnlOperacion : ' + pnlOperacion);
	console.log('       pnlMensajes : ' + pnlMensajes);

	if (operacionCancelada == true) {
		RichFaces.ui.PopupPanel.showPopupPanel(pnlMensajes);
		console.log('function eliminarFacturaRefacturar ERROR\n------------------------------');
		return;
	}
	...
	if (refacturar == true)
		RichFaces.ui.PopupPanel.showPopupPanel(pnlOperacion);
	console.log('function eliminarFacturaRefacturar DONE\n------------------------------');
}

function cancelarFacturaRefacturar(operacionCancelada, refacturar, pnlEliminar, pnlOperacion, pnlMensajes, validador) {
	console.log('------------------------------');
	console.log('cancelarFacturaRefacturar(operacionCancelada, refacturar, pnlEliminar, pnlOperacion, pnlMensajes, validador)\n');
	console.log('  operacionCancelada : ' + operacionCancelada);
	console.log('  refacturar         : ' + refacturar);
	console.log('  pnlEliminar        : ' + pnlEliminar);
	console.log('  pnlOperacion       : ' + pnlOperacion);
	console.log('  pnlMensajes        : ' + pnlMensajes);
	console.log('  validador          : \n');
	console.log(validador);
	...
	console.log('validando campos requeridos ... ');
	if (campos_requeridos(validador)) {
		console.log('function cancelarFacturaRefacturar REQUERIDOS\n------------------------------');
		return;
	}

	console.log('validando operacion ... ');
	if (operacionCancelada == true) {
		RichFaces.ui.PopupPanel.showPopupPanel(pnlMensajes);
		console.log('function cancelarFacturaRefacturar ERROR\n------------------------------');
		return;
	}

	console.log('cerrando dialogo cancelacion ... ');
	...
	console.log('function cancelarFacturaRefacturar DONE\n------------------------------');
}
...
function refacturar(operacionCancelada, pnlOperacion, pnlMensajes) {
	...
	RichFaces.ui.PopupPanel.showPopupPanel(pnlOperacion);
	console.log('function refacturar DONE\n------------------------------');
}
...
//function validarTimbrar(operacionCancelada, pnlOperacion, pnlMensajes) {
...
function timbrar(operacionCancelada, pnlOperacion, pnlMensajes, validador) {
	...
	console.log('Ejecutando pnlMensajes con: RichFaces.ui.PopupPanel.showPopupPanel("' + pnlMensajes + '");');
	RichFaces.ui.PopupPanel.showPopupPanel(pnlMensajes);
	if (operacionCancelada == true) {
		console.log('ERROR\n------------------------------');
		return;
	...
	console.log('Ejecutando pnlOperacion con: RichFaces.ui.PopupPanel.hidePopupPanel("' + pnlOperacion + '");');
	RichFaces.ui.PopupPanel.hidePopupPanel(pnlOperacion);
	console.log('DONE\n------------------------------');
}
