...
public class ManualesAction implements Serializable {
	...
	private void cargarProcesos() {
		...
		try {
			...
			valor = this.entornoProperties.getString("procesos").trim();
			extraPath = (this.entornoProperties.getString("procesos_path") != null && ! "".equals(this.entornoProperties.getString("procesos_path")) ? this.entornoProperties.getString("procesos_path").trim() : "");
			if (valor != null && ! "".equals(valor.trim())) {
				splitted = valor.split(",");
