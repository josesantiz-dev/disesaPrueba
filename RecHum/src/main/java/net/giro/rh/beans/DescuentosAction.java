...
public class DescuentosAction implements Serializable {
	private static final long serialVersionUID = 1L;
	private static Logger log = Logger.getLogger(DescuentosAction.class);
    ...
    public void buscar() {
    	try {
			...
			this.listEmpleados = this.ifzEmpleados.findLike(this.valorBusqueda, "primerApellido, segundoApellido, primerNombre, segundoNombre", 0, 0);
    ...
    public void editar() {
    	try {
			...
			if (this.pojoEmpleadoDescuento.getNumeroPagos() == 1) {
				...
				params.put("idDescuento", String.valueOf(this.pojoEmpleadoDescuento.getIdDescuento()));
				params.put("idPeriodo", String.valueOf(this.pojoEmpleadoDescuento.getIdPeriodo()));
