...
public interface OrdenCompraDetalleRem {
	...
	public List<OrdenCompraDetalleExt> saveOrUpdateListExt(List<OrdenCompraDetalleExt> entities) throws Exception;
	
	public void update(OrdenCompraDetalleExt entityExt) throws Exception;
	
	public OrdenCompraDetalleExt findExtById(Long idOrdenCompraDetalleExt) throws Exception;
