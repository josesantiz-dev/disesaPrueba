...
public class OperacionesIntegradasSqlAction implements Serializable {
	...
	public String getOperacionIntegrada() {
		if (this.pojoOperIntSql != null && this.pojoOperIntSql.getIdOperacionIntegrada() != null && this.pojoOperIntSql.getIdOperacionIntegrada().getId() != null && this.pojoOperIntSql.getIdOperacionIntegrada().getId() > 0L)
			return this.pojoOperIntSql.getIdOperacionIntegrada().toString();
		return "";
	}
